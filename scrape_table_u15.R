...
url <- "https://bev-eishockey.de/a1e24d834f0cc1c366e4ae14119d3744/242"
...
if (length(tables) >= 2) {
  ...
  write_csv(second_table, "tabelle_U15.csv")
  cat("Zweite Tabelle erfolgreich als tabelle_U15.csv gespeichert!")
} else {
